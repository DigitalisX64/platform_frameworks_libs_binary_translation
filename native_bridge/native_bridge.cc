...
// __progname patch immediately below) because the host process's setenv()
...
static void DigitalisInjectQtPluginPath(void* guest_libc,
  ...
  berberis::GuestAddr environ_addr =
      const_cast<NdktNativeBridge&>(bridge).DlSym(guest_libc, "environ");
