...
int ToGuestSyscallNumber(int nr) {
  switch (nr) {
    case 156:  // __NR__sysctl - missing on arm64
      return -1;
    case 43:  // __NR_accept
      return 202;
    case 288:  // __NR_accept4
      return 242;
    case 21:  // __NR_access - missing on arm64
      return -1;
    case 163:  // __NR_acct
      return 89;
    ...
    case 159:  // __NR_adjtimex
      return 171;
    case 183:  // __NR_afs_syscall - missing on arm64
      return -1;
    case 37:  // __NR_alarm - missing on arm64
      return -1;
    case 158:  // __NR_arch_prctl - missing on arm64
      return -1;
    case 49:  // __NR_bind
      return 200;
    case 321:  // __NR_bpf
    ...
    case 80:  // __NR_chdir
      return 49;
    case 90:  // __NR_chmod - missing on arm64
      return -1;
    case 92:  // __NR_chown - missing on arm64
      return -1;
    ...
    case 326:  // __NR_copy_file_range
      return 285;
    case 85:  // __NR_creat - missing on arm64
      return -1;
    case 174:  // __NR_create_module - missing on arm64
      return -1;
    case 176:  // __NR_delete_module
      return 106;
    case 32:  // __NR_dup
      return 23;
    case 33:  // __NR_dup2 - missing on arm64
      return -1;
    case 292:  // __NR_dup3
      return 24;
    case 213:  // __NR_epoll_create - missing on arm64
      return -1;
    case 291:  // __NR_epoll_create1
      return 20;
    case 233:  // __NR_epoll_ctl
      return 21;
    case 214:  // __NR_epoll_ctl_old - missing on arm64
      return -1;
    case 281:  // __NR_epoll_pwait
      return 22;
    case 441:  // __NR_epoll_pwait2
      return 441;
    case 232:  // __NR_epoll_wait - missing on arm64
      return -1;
    case 215:  // __NR_epoll_wait_old - missing on arm64
      return -1;
    case 284:  // __NR_eventfd - missing on arm64
      return -1;
    ...
    case 73:  // __NR_flock
      return 32;
    case 57:  // __NR_fork - missing on arm64
      return -1;
    ...
    case 449:  // __NR_futex_waitv
      return 449;
    case 261:  // __NR_futimesat - missing on arm64
      return -1;
    case 177:  // __NR_get_kernel_syms - missing on arm64
      return -1;
    case 239:  // __NR_get_mempolicy
      return 236;
    case 274:  // __NR_get_robust_list
      return 100;
    case 211:  // __NR_get_thread_area - missing on arm64
      return -1;
    case 309:  // __NR_getcpu
      return 168;
    case 79:  // __NR_getcwd
      return 17;
    case 78:  // __NR_getdents - missing on arm64
      return -1;
    ...
    case 121:  // __NR_getpgid
      return 155;
    case 111:  // __NR_getpgrp - missing on arm64
      return -1;
    case 39:  // __NR_getpid
      return 172;
    case 181:  // __NR_getpmsg - missing on arm64
      return -1;
    ...
    case 254:  // __NR_inotify_add_watch
      return 27;
    case 253:  // __NR_inotify_init - missing on arm64
      return -1;
    ...
    case 16:  // __NR_ioctl
      return 29;
    case 173:  // __NR_ioperm - missing on arm64
      return -1;
    case 172:  // __NR_iopl - missing on arm64
      return -1;
    ...
    case 446:  // __NR_landlock_restrict_self
      return 446;
    case 94:  // __NR_lchown - missing on arm64
      return -1;
    case 192:  // __NR_lgetxattr
      return 9;
    case 86:  // __NR_link - missing on arm64
      return -1;
    ...
    case 189:  // __NR_lsetxattr
      return 6;
    case 6:  // __NR_lstat - missing on arm64
      return -1;
    ...
    case 27:  // __NR_mincore
      return 232;
    case 83:  // __NR_mkdir - missing on arm64
      return -1;
    case 258:  // __NR_mkdirat
      return 34;
    case 133:  // __NR_mknod - missing on arm64
      return -1;
    ...
    case 9:  // __NR_mmap
      return 222;
    case 154:  // __NR_modify_ldt - missing on arm64
      return -1;
    case 165:  // __NR_mount
      return 40;
    case 442:  // __NR_mount_setattr
    ...
    case 180:  // __NR_nfsservctl
      return 42;
    case 2:  // __NR_open - missing on arm64
      return -1;
    ...
    case 437:  // __NR_openat2
      return 437;
    case 34:  // __NR_pause - missing on arm64
      return -1;
    ...
    case 424:  // __NR_pidfd_send_signal
      return 424;
    case 22:  // __NR_pipe - missing on arm64
      return -1;
    case 293:  // __NR_pipe2
      return 59;
    ...
    case 329:  // __NR_pkey_mprotect
      return 288;
    case 7:  // __NR_poll - missing on arm64
      return -1;
    case 271:  // __NR_ppoll
      return 73;
    case 157:  // __NR_prctl
    ...
    case 101:  // __NR_ptrace
      return 117;
    case 182:  // __NR_putpmsg - missing on arm64
      return -1;
    ...
    case 328:  // __NR_pwritev2
      return 287;
    case 178:  // __NR_query_module - missing on arm64
      return -1;
    ...
    case 187:  // __NR_readahead
      return 213;
    case 89:  // __NR_readlink - missing on arm64
      return -1;
    ...
    case 197:  // __NR_removexattr
      return 14;
    case 82:  // __NR_rename - missing on arm64
      return -1;
    ...
    case 219:  // __NR_restart_syscall
      return 128;
    case 84:  // __NR_rmdir - missing on arm64
      return -1;
    case 334:  // __NR_rseq
      return 293;
    ...
    case 317:  // __NR_seccomp
      return 277;
    case 185:  // __NR_security - missing on arm64
      return -1;
    case 23:  // __NR_select - missing on arm64
      return -1;
    case 66:  // __NR_semctl
      return 191;
    case 64:  // __NR_semget
    ...
    case 273:  // __NR_set_robust_list
      return 99;
    case 205:  // __NR_set_thread_area - missing on arm64
      return -1;
    ...
    case 131:  // __NR_sigaltstack
      return 132;
    case 282:  // __NR_signalfd - missing on arm64
      return -1;
    ...
    case 275:  // __NR_splice
      return 76;
    case 4:  // __NR_stat - missing on arm64
      return -1;
    ...
    case 167:  // __NR_swapon
      return 224;
    case 88:  // __NR_symlink - missing on arm64
      return -1;
    ...
    case 306:  // __NR_syncfs
      return 267;
    case 139:  // __NR_sysfs - missing on arm64
      return -1;
    ...
    case 234:  // __NR_tgkill
      return 131;
    case 201:  // __NR_time - missing on arm64
      return -1;
    ...
    case 76:  // __NR_truncate
      return 45;
    case 184:  // __NR_tuxcall - missing on arm64
      return -1;
    case 95:  // __NR_umask
      return 166;
    ...
    case 63:  // __NR_uname
      return 160;
    case 87:  // __NR_unlink - missing on arm64
      return -1;
    case 263:  // __NR_unlinkat
      return 35;
    case 272:  // __NR_unshare
      return 97;
    case 134:  // __NR_uselib - missing on arm64
      return -1;
    case 323:  // __NR_userfaultfd
      return 282;
    case 136:  // __NR_ustat - missing on arm64
      return -1;
    case 132:  // __NR_utime - missing on arm64
      return -1;
    case 280:  // __NR_utimensat
      return 88;
    case 235:  // __NR_utimes - missing on arm64
      return -1;
    case 58:  // __NR_vfork - missing on arm64
      return -1;
    case 153:  // __NR_vhangup
      return 58;
    case 278:  // __NR_vmsplice
      return 75;
    case 236:  // __NR_vserver - missing on arm64
      return -1;
    case 61:  // __NR_wait4
      return 260;
